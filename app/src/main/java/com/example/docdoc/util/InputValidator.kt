...
class InputValidator() {
    ...
    /** funzione che verifica se il codice fiscale è valido.
    ...
    /** funzione che verifica se il numero di telefono è valido.
    ...
    /** funzione che verifica se l'indirizzo è valido.
